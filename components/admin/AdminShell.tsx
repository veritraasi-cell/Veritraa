  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#fcf4e8,#f7e9d6)] text-[#4b1f0f]">
      <div className="lg:grid lg:min-h-screen lg:grid-cols-[18rem_minmax(0,1fr)]">
        ...
        <aside
          className={`fixed inset-y-0 left-0 z-40 flex w-72 flex-col border-r border-[#e3c7ab] bg-[#fffaf4]/96 p-5 shadow-[0_24px_54px_-40px_rgba(63,28,16,0.55)] backdrop-blur transition-transform duration-300 lg:sticky lg:top-0 lg:h-screen lg:overflow-auto lg:translate-x-0 ${
